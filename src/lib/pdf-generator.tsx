...
function FindingsPage({ result, scaleFactor, verticalId, companyName }: { result: AnalysisResult; scaleFactor: number; verticalId?: string; companyName: string }) {
  ...
  return (
    <Page size="A4" style={s.paperPage}>
      ...
      <View style={{ marginBottom: 12, padding: 10, backgroundColor: '#f7f4ef', borderRadius: 6, borderLeftWidth: 3, borderLeftColor: '#1a1a1a', borderLeftStyle: 'solid' }}>
