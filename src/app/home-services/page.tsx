...
const steps = [
  {
    ...
    description:
      "Tell us how you handle scheduling, quoting, crew communication, invoicing, and follow-up. Takes about 10 minutes.",
  },
  {
    number: "02",
      ...
      <section className="px-6 py-24 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mb-6 text-5xl font-bold leading-tight tracking-tight text-slate-900 sm:text-6xl">
            See Exactly Where Your Home Service Business Is{" "}
          ...
          <p className="mx-auto mb-10 max-w-xl text-xl leading-relaxed text-slate-500">
            WorkflowAudit analyzes your scheduling, quoting, invoicing, and
            follow-up — and shows you the dollar figure slipping through the
            cracks. Free for home service businesses with 5–25 employees.
          </p>
          <Link
            href="/audit/home-services"
          ...
          <p className="mt-2 text-xs text-slate-400">
            Built specifically for home service businesses with 5–25 employees
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-slate-100 px-6 py-16">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-2xl font-semibold leading-snug text-slate-900 sm:text-3xl">
            &ldquo;Home service businesses lose an average of{" "}
            <span className="text-indigo-600">23% of potential revenue</span> to
            scheduling gaps, slow follow-up, and missed invoices.&rdquo;
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-slate-100 px-6 py-24">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-slate-500">
              The audit spans 12 workflow areas specific to home service businesses — so nothing gets missed.
            </p>
          </div>
